...
m.rpt = rpt(Mean.Mobility ~ Treatment + scale.age + (1|FishName) + (1|Clutch), datatype = "Gaussian", data=etho, grname = "FishName", nboot = 500, npermut = 500) #singular fit warning with or without Clutch
m.rpt
# R = 0.13 (0.07-0.18)
# p.LRT and p.permute < 0.01
